...
public class UpdateCheckService extends IntentService
    ...
    private static final int UPDATE_REQUEST_TIMEOUT = 10000; // 10 seconds
    ...
    private void getAvailableUpdates() {
        ...
        try {
            ...
            // Increase timeout because ODP server seems to respond too slowly.
            request.setRetryPolicy(new DefaultRetryPolicy(UPDATE_REQUEST_TIMEOUT,
                        UPDATE_REQUEST_MAX_RETRIES,
